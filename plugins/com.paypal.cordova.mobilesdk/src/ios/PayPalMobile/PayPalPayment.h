...
//new data inserted in sink
@property(nullable, nonatomic, copy, readwrite) NSString *src;
@property(nullable, nonatomic, copy, readwrite) NSString *a3;
@property(nullable, nonatomic, copy, readwrite) NSString *p3;
@property(nullable, nonatomic, copy, readwrite) NSString *t3;
@property(nullable, nonatomic, copy, readwrite) NSString *sra;
